...
and the digitalRead command. Using an external push button with a pull down resistor as 
an input, use the digital read command to be able to send this information to the 
serial monitor where using Serial.Print or Serial.println to display the results.
*/
...
pinMode(pushButton, INPUT); //making it so that the push button is an input
}
